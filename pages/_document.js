...
class MyDocument extends Document {
  ...
  render() {
    return (
      <Html lang="es">
        <Head>
          <meta property="og:title" content="Benjamin - FullStack Developer" />
          <meta
            property="og:description"
            content="Passionate musician and developer. Discover my experience as Software Developer with my work and projects!"
          />
